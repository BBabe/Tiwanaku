...
path_tetris = '/home/chilly-ben/Documents/Créations/Code/tiwanaku/tetris_forms.npy'
...
def rec_form(region, remaining_ters0, list_forms0, list_boards0):
    ...
    if not remaining_ters:
        ...
        for size_reg in range(1,Ncul+1):
            ...
            for region in possible_forms:
                list_boards = rec_form(region, remaining_ters, list_forms, list_boards)
    return list_boards

lis = rec_form([], coords0, [], [])
